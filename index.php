...
$emp1 = new Plantilla("Asier", "Gonzalez", "01-36500028-76", 800, 75);
$emp2 = new Plantilla("Mikel", "Goicoechea", "32-90891510-58", 1000, 100);
$resultado .= "<h2>Empleado:</h2>";
$resultado .= "<h2>Empleado Asalariado:</h2>";
$resultado .= $emp1->mostrar();
$resultado .= "<br>" . $emp2->mostrar() . "<br>";

$empc1 = new EmpleadoComision("Iñigo", "Aguirre", "40-97211580-62", 30, 350, 175);
$empc2 = new EmpleadoComision("Aimar", "Goicoechea", "29-30586572-68", 35, 200, 325);
